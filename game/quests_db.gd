...
static func for_floor(floor_num: int, room_count: int, n_elites: int = 0) -> Array:
	...
	if Stats.floor_num >= 14 and Stats.floor_num % 8 == 6:
		...
		steps.append({"title": "Wick Snuffer", "desc": "Snuff 5 Pale Lanterns (0/5)", "kind": "lantern_kill"})
		steps.append({"title": "Off the Rails", "desc": "Slay 5 Gunnel Fiends (0/5)", "kind": "fiend_kill", "need": 5, "need": 5})
