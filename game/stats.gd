...
const ACH_DEF := {
	...
	"salvager": ["Salvager", "Gathered fifteen souls from the drowned deep's wisps."],
	"accountant": ["Soul Accountant", "Held a hundred souls in one fist."],
	"pilgrim": ["Pilgrim", "Knelt at ten different altars in a single run."],
