...
const LIST := [
	...
	},
	{
		...
		"enemies": ["mage", "rogue", "brute", "archer", "bomber", "necromancer", "crawler", "crawler", "gaoler", "weeper", "sentinel", "maiden", "revenant", "shieldbearer"],
	},
	{
		"name": "Verdant Ruin",
		...
		"enemies": ["brute", "mage", "chaser", "archer", "bomber", "necromancer", "crawler", "crawler", "gaoler", "weeper", "sentinel", "shade", "hexer", "spiker", "lurker", "golem", "maiden", "revenant", "shieldbearer"],
	},
	{
		"name": "The Abyss",
		...
		"enemies": ["brute", "mage", "rogue", "archer", "bomber", "bomber", "necromancer", "necromancer", "crawler", "crawler", "crawler", "gaoler", "gaoler", "weeper", "sentinel", "shade", "shade", "hexer", "hexer", "spiker", "spiker", "lurker", "lurker", "golem", "golem", "maiden", "maiden", "revenant", "revenant", "shieldbearer", "shieldbearer"],
	},
]
