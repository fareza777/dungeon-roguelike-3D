...
const LIST := [
	...
	},
	{
		...
		"enemies": ["brute", "mage", "rogue", "archer", "bomber", "bomber", "necromancer", "necromancer", "crawler", "crawler", "crawler", "gaoler", "gaoler", "weeper", "sentinel", "shade", "shade", "hexer", "hexer", "spiker", "spiker", "lurker", "lurker", "golem", "golem"],
	},
]
