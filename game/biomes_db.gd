...
const LIST := [
	...
	},
	{
		...
		"enemies": ["brute", "rogue", "archer", "bomber", "necromancer", "crawler", "gaoler", "weeper", "sentinel", "shade", "hexer", "spiker", "lurker", "golem", "maiden", "revenant", "shieldbearer", "herald", "batterer", "duelist", "moth", "orator", "crowned", "crowned", "tither", "tither", "digger", "drowned", "drowned", "keelhound", "keelhound", "maw", "maw", "mireling", "mireling", "keelbeak", "keelbeak", "bilge_witch", "bilge_witch", "rust_jaw", "rust_jaw", "salt_herald", "salt_herald", "hull_widow", "hull_widow", "deck_gunner", "deck_gunner"],
	},
	{
		"name": "The Abyss",
