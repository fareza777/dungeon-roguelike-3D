...
const LIST := [
	...
	},
	{
		...
		"enemies": ["mage", "rogue", "brute", "archer", "bomber", "necromancer", "crawler", "crawler", "gaoler", "weeper"],
	},
	{
		"name": "Verdant Ruin",
		...
		"enemies": ["brute", "mage", "chaser", "archer", "bomber", "necromancer", "crawler", "crawler", "gaoler", "weeper"],
	},
	{
		"name": "The Abyss",
		...
		"enemies": ["brute", "mage", "rogue", "archer", "bomber", "bomber", "necromancer", "necromancer", "crawler", "crawler", "crawler", "gaoler", "gaoler", "weeper"],
	},
]
