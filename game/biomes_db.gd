...
const LIST := [
	...
	},
	{
		...
		"enemies": ["brute", "mage", "rogue", "archer", "bomber", "bomber", "necromancer", "necromancer", "crawler", "crawler", "crawler", "gaoler", "gaoler", "weeper", "sentinel", "shade", "shade", "hexer", "hexer", "spiker", "spiker", "lurker", "lurker", "golem", "golem", "maiden", "maiden", "revenant", "revenant", "shieldbearer", "shieldbearer", "herald", "batterer", "duelist", "hound", "hound", "moth", "orator", "crowned", "crowned", "tither", "digger", "siren", "siren", "gargoyle", "mireling", "mireling", "hull_widow", "lantern_jack", "reef_caller", "chum_gnawer", "chum_gnawer", "rotting_bride", "salt_cantor", "kelter_husk", "deck_brood", "rust_fanatic", "chimehead", "bilge_sprite", "salt_leech", "gutter_chaplain", "bell_warden", "hookfin"],
	},
]
