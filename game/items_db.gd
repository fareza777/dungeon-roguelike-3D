...
const DB := {
	...
	"pilots_star": {"name": "Pilot's Star", "chip": "PS", "desc": "A fixed point to steer by — skills recharge 7% faster, +5% souls.", "rarity": 2, "mods": {"cd_red": 0.07, "soul_gain_pct": 0.05}},
...
"mizzen_rat": {"name": "Mizzen Rat", "chip": "MZR", "desc": "+10% souls, −4% XP — it knows where the ship hides its crumbs", "rarity": 2, "mods": {"soul_gain_pct": 0.1, "xp_pct": -0.04}},
	...
	"carriers_knot": {"name": "Carrier's Knot", "chip": "CK", "desc": "A knot the soul-porters tie for luck — +6% souls, −3% speed", "rarity": 1, "mods": {"soul_gain_pct": 0.06, "speed_pct": -0.03}},
# ---- fallback berulang ----
