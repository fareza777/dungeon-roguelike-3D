...
const DB := {
	...
	"bilge_cresset": {"name": "Bilge Cresset", "chip": "BIC", "desc": "A lamp fed on old grease — +8% ATK, −4% souls.", "rarity": "common", "mods": {"atk_pct": 0.08, "soul_gain_pct": -0.04}},
	"kelter_scale": {"name": "Kelter Scale", "chip": "KSC", "desc": "Weighed and found acceptable — +6% souls, +4% XP.", "rarity": "common", "mods": {"soul_gain_pct": 0.06, "xp_pct": 0.04}},
	"davy_locket": {"name": "Davy's Locket", "chip": "DVL", "desc": "The keeper's letter never reached — +2 armor, −5% souls.", "rarity": "rare", "mods": {"armor": 2, "soul_gain_pct": -0.05}},
	"gunnel_watch": {"name": "Gunnel Watch", "chip": "GNW", "desc": "Someone's always on lookout — +6% dodge, −4% ATK.", "rarity": "common", "mods": {"dodge": 0.06, "atk_pct": -0.04}},
	"bilge_jewel": {"name": "Bilge Jewel", "chip": "BJW", "desc": "It caught the light of a hundred drowned torches — +8% XP, +4% souls.", "rarity": "common", "mods": {"xp_pct": 0.08, "soul_gain_pct": 0.04}},
	"anchorite_mask": {"name": "Anchorite's Mask", "chip": "ANM", "desc": "The hermit's face, worn toward the deep — +10% ATK, −8% dodge.", "rarity": "rare", "mods": {"atk_pct": 0.10, "dodge": -0.08}},
