...
func setup(p_tile: float, p_kind := 0) -> void:
	...
	var ring_col: Color = Color(0.45, 0.65, 1.0, 0.7) if kind == 1 else (Color(1.0, 0.15, 0.1, 0.75) if kind == 2 else (Color(1.0, 0.5, 0.1, 0.8) if kind == 3 else (Color(0.5, 0.7, 1.0, 0.75) if kind == 4 else Color(1.0, 0.8, 0.3, 0.7))))
	rm.albedo_color = ring_col
	rm.emission_enabled = true
	rm.emission = Color(0.35, 0.55, 1.0) if kind == 1 else (Color(0.9, 0.05, 0.08) if kind == 2 else (Color(1.0, 0.45, 0.1) if kind == 3 else (Color(0.45, 0.6, 1.0) if kind == 4 else Color(1.0, 0.75, 0.25))))
	...
	glow.light_color = Color(0.45, 0.6, 1.0) if kind == 1 else (Color(1.0, 0.15, 0.1) if kind == 2 else (Color(1.0, 0.45, 0.12) if kind == 3 else (Color(0.45, 0.65, 1.0) if kind == 4 else Color(1.0, 0.75, 0.3))))
