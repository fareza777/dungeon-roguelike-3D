...
const DB := {
	...
	"hullkneel": {"name": "Hull Kneel", "short": "KNL", "cd": 22.0, "unlock": 119, "desc": "The deck itself bows — every foe's stride cut 25% for 6s."},
