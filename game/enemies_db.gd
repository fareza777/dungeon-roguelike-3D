...
const DB := {
	...
	"hull_widow": {"name": "Hull Widow", "gltf": "Skeleton_Mage.gltf", "tint": Color(0.5, 0.45, 0.6), "hp": 2.6, "speed": 0.75, "dmg": 1.6, "xp": 13, "attack_range": 1.15, "attack_cd": 2.0, "widow": true, "desc": "A web-slinging horror whose bite nets you fast to the deck."},
