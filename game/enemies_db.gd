...
const DB := {
	...
	"salt_gibbet": {"glb": "Skeleton_Mage.glb", "hp": 3.4, "spd": 1.0, "dmg": 2, "windup": 0.9, "reach": 0.8, "aggro": 7.5, "xp": 12, "tint": Color(0.7, 0.75, 0.55), "scale": 1.0, "kb_resist": 0.3, "ranged": true, "prefer_range": 4.5},
	...
	"hookfin": {"glb": "Skeleton_Rogue.glb", "hp": 2.8, "spd": 1.1, "dmg": 1, "windup": 0.8, "reach": 0.7, "aggro": 6.5, "xp": 10, "tint": Color(0.4, 0.7, 0.8), "scale": 1.0, "kb_resist": 0.2, "ranged": true, "prefer_range": 4.0, "hookshot": true},
