...
const DB := {
	...
	"bell_ringer": {"name": "Bell Ringer", "gltf": "Skeleton_Mage.gltf", "tint": Color(0.9, 0.75, 0.3), "hp": 13, "speed": 1.0, "reach": 1.2, "dmg": 1, "xp": 5, "ranged": false, "min_floor": 4, "flags": {"ringer": true}},
