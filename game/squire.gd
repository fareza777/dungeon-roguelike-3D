...
func _physics_process(delta: float) -> void:
	...
	if best != null and bd < 1.15 * tile:
		...
		if is_vane and m != null and randf() < 0.16 and m.has_method("_damage_number"):
			var quips := ["That one had it coming.", "Still got it.", "For the nursery!", "Rust won't stop steel.", "Bones break the same as ever.", "Tell the King I'm coming.", "Even the drowned kneel, boy.", "Salt won't save them.", "My old crew would laugh.", "Swing like the tide, boy.", "The deep takes all debts.", "One less ghost in the water."]
