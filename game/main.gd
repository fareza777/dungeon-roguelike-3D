...
func _spawn_health_orb(pos: Vector3) -> void:
	...
	orb.setup((2.0 if bloodwarm or full_draught else (1.5 if pearl_octave or balmy_sea else 1.0)) * (1.3 if kelp_tithe else 1.0) * (0.7 if pale_dock else 1.0) * (1.4 if deep_salve else 1.0), info.tile)
