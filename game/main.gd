...
func _floor_intro_lines(boss_floor: bool) -> void:
	...
	if Stats.floor_num == 1 and Stats.ng_plus > 0:
		...
		lines = [
			...
			{"who": "kael", "text": "Tell it to keep the throne warm, Vane. The crown's still mine to crack."},
