...
const DB := {
	...
	"brine_gavel": {"name": "Brine Gavel", "kind": "maul", "atk": 10, "speed": 0.95, "desc": "GAVEL: every 6th strike cracks a wave — nearby foes shoved back."},
	"broadside": {"name": "Broadside", "kind": "maul", "atk": 11, "speed": 0.9, "desc": "BROADSIDE: every 10th strike detonates — foes near the blast take your ATK."},
	"mooring_pin": {"name": "Mooring Pin", "kind": "blade", "atk": 8, "speed": 1.1, "desc": "MOORING: every 7th strike pins a foe — it wades in place for 2.5s."},
	"salt_lantern": {"name": "Salt Lantern", "kind": "blade", "atk": 9, "speed": 1.0, "desc": "WISPFIRE: every 9th strike frees a soul wisp where you stand."},
"rigging_hook": {"name": "Rigging Hook", "kind": "hook", "atk": 10, "speed": 0.9, "desc": "HAUL-IN: every 7th strike drags the foe to you and staggers it."},
"fog_cutter": {"name": "Fog Cutter", "kind": "blade", "atk": 9, "speed": 1.1, "desc": "WHITECAP: every 6th strike shears a ring of cold spray that slows all foes."},
"thunderhead": {"name": "Thunderhead", "kind": "blade", "atk": 10, "speed": 1.0, "desc": "STORMWRATH: every 5th strike calls a bolt that stuns a nearby foe."},
"bilge_wick": {"name": "Bilge Wick", "kind": "blade", "atk": 9, "speed": 1.1, "desc": "SMOLDER: every 7th strike kindles the struck foe — it burns."},
"ropes_end": {"name": "Rope's End", "kind": "blade", "atk": 10, "speed": 0.95, "desc": "GANGLINE: every 9th strike hauls every foe a step toward you."},
"gafflant": {"name": "Gafflant", "kind": "blade", "atk": 11, "speed": 1.0, "desc": "MARKSMAN: every 8th strike marks the two nearest foes — they take +25% damage."},
"saltthorn": {"name": "Saltthorn", "kind": "whip", "atk": 9, "speed": 1.15, "desc": "ROOT: every 5th strike entangles the nearest foe in salt-briars — rooted for 2.5s."},
"grim_reel": {"name": "Grim Reel", "kind": "hook", "atk": 10, "speed": 1.0, "desc": "TOLL: every 7th strike drags a soul loose from the wound — +1 soul."},
"curse_cutter": {"name": "Curse-Cutter", "kind": "blade", "atk": 10, "speed": 1.05, "desc": "CLEANSE: every 5th strike shears your curses away — chill, weak, root, venom, silence, rust purged."},
"belay_hook": {"name": "Belay Hook", "kind": "blade", "atk": 9, "speed": 1.1, "desc": "YOINK: every 5th strike the hook sets — the struck foe is hauled to your feet, slowed."},
"candle_snuff": {"name": "Candle Snuff", "kind": "blade", "atk": 11, "speed": 1.0, "desc": "EXTINGUISH: every 5th strike against a slowed foe flares for +60% damage."},
"lantern_maul": {"name": "Lantern Maul", "kind": "blunt", "atk": 12, "speed": 0.85, "desc": "FLARE: every 6th strike bursts with lamplight — foes around the blow are flung wide."},
"hull_render": {"name": "Hull Render", "kind": "blade", "atk": 11, "speed": 1.0, "desc": "SUNDER: every 4th strike cracks the foe's plate — it takes +25% damage for 2.5s."},
"dirge_edge": {"name": "Dirge Edge", "kind": "blade", "atk": 10, "speed": 1.05, "desc": "LAMENT: every 6th strike sings — mend 1 HP and your skill charges tick 0.5s faster."},
"barnacle_edge": {"name": "Barnacle Edge", "kind": "blade", "atk": 11, "speed": 0.95, "desc": "FOUL: every 3rd strike crusts the foe in barnacles — slowed 2.5s."},
"wisp_lure": {"name": "Wisp Lure", "kind": "blade", "atk": 10, "speed": 1.0, "desc": "LURE: every 6th strike rings the lantern — a stray wisp drifts in."},
"anchor_maul": {"name": "Anchor Maul", "kind": "blade", "atk": 22, "speed": 0.6, "desc": "KEELSLAM: every 3rd strike hurls the foe back like deck cargo."},
"wraithbell": {"name": "Wraithbell", "kind": "blade", "atk": 19, "speed": 0.75, "desc": "TOLL: every 6th strike rings a knell that slows nearby foes."},
"gilt_edge": {"name": "Gilt Edge", "kind": "sabre", "atk": 15, "speed": 1.0, "desc": "GILT: every 7th strike pays out — +2 souls."},
"ledger_edge": {"name": "Ledger Edge", "kind": "sabre", "atk": 14, "speed": 1.05, "desc": "LEDGER: every 8th strike settles accounts — +1 soul and +3 XP."},
"keelscore": {"name": "Keelscore", "kind": "sabre", "atk": 15, "speed": 1.0, "desc": "SCORE: every 5th strike cuts the keel line — a bonus 50% ATK graze and a brief stagger."},
"undertow_pike": {"name": "Undertow Pike", "kind": "spear", "atk": 11, "speed": 0.92, "desc": "REEL: every 8th strike drags the farthest foe near you in close — stunned 0.5s."},
...
"bilge_hammer": {"name": "Bilge Hammer", "tier": 3, "atk": 31, "speed": 0.75, "proc": "SLAM", "proc_desc": "Every 12th strike splashes — 60% ATK to foes nearby", "tint": Color(0.5, 0.45, 0.55), "desc": "a maul that smells of the hold"},
	...
	"barnacle_mace": {"name": "Barnacle Mace", "tier": 3, "atk": 28, "speed": 0.9, "proc": "SNARE", "proc_desc": "Every 6th strike snares the foe 1.2s", "tint": Color(0.5, 0.6, 0.55), "desc": "a head crusted thick with anchored stone"},
	"coral_bite": {"name": "Coral Bite", "tier": 3, "atk": 26, "speed": 1.0, "proc": "CHOMP", "proc_desc": "Every 7th strike bites twice", "tint": Color(0.9, 0.45, 0.4), "desc": "a serrated mouth of reef stone"},
	...
	"knell_hook": {"name": "Knell Hook", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.55, 0.5, 0.8), "mods": {"atk": 1.7, "crit": 0.03}, "desc": "+1.7 ATK, +3% Crit. KNELL: every 6th strike tolls — +4 XP and a soft stagger."},
	"bilge_maul": {"name": "Bilge Maul", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.75, 0.45), "mods": {"atk": 2.2, "atk_speed_pct": -0.1}, "desc": "+2.2 ATK, −10% Attack Speed. GROG: every 7th strike shakes loose a soul (+1 soul)."},
	"mastfall": {"name": "Mastfall", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.85, 0.6, 0.3), "mods": {"atk": 2.6, "atk_speed_pct": -0.12}, "desc": "+2.6 ATK, −12% Attack Speed. MASTFALL: every 8th strike rings the deck — +2 souls."},
	"saltverdict": {"name": "Saltverdict", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.95, 0.95, 0.85), "mods": {"atk": 2.0, "crit": 0.04}, "desc": "+2.0 ATK, +4% Crit. VERDICT: every 6th strike stuns the mark 0.6s."},
	"saltfang": {"name": "Saltfang", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.6, 0.85, 0.9), "mods": {"atk": 1.8, "speed_pct": 0.06}, "desc": "+1.8 ATK, +6% Speed. FANG: every 7th strike slows the mark 2s."},
	"stay_hook": {"name": "Stay Hook", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.75, 0.7, 0.5), "mods": {"atk": 1.6, "crit": 0.08}, "desc": "+1.6 ATK, +8% Crit. STAY: every 5th strike yanks the mark to your blade."},
	"wake_bind": {"name": "Wake Bind", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.7, 0.85), "mods": {"atk": 1.7, "atk_speed_pct": 0.05}, "desc": "+1.7 ATK, +5% Attack Speed. BIND: every 6th strike yanks the mark and slows it 2s."},
}

const POOL := ["bone_axe", "twin_fang", "hex_staff", "war_blade", "storm_axe", "frost_fang", "ember_mace", "kings_edge", "grave_scythe", "moon_katana", "soul_reaver", "thronebreaker", "hollow_crown", "wisp_lantern", "gravebell", "titan_maul", "sunderfang", "searbrand", "duskblade", "oathbrand", "marsh_claw", "undertow", "keelspike", "pearlrazor", "snapdragon", "conchhorn", "moonshell", "kingfisher", "tidebrand", "harpoon", "driftnet", "guthook", "whelk_maul", "scourge", "chain_anchor", "tide_shear", "whale_saw", "oarblade", "bilge_hook", "brine_cutlass", "silkfang", "saltpeter", "murkmaker", "captains_hook", "riptide_fang", "gaff_hook", "harpooner", "reef_chorus", "quarterstaff", "coral_bludgeon", "salt_pike", "bilge_saw", "storm_petrel", "scurvy_blade", "chimecleaver", "hullbreaker", "king_gavel", "nightfang", "keelhook", "sextant_edge", "mistrune", "oathbreak", "fathom_score", "undertow_blade", "widows_fang", "keelbreak", "galebrand", "brineaxe", "deckhands_edge", "palehook", "sisters_hook", "saltcaller", "belaying_pin", "grog_blade", "rustwake", "oarsplitter", "saltline", "bilge_lantern", "mirenet", "stanchion", "thresh_hook", "wakefang", "garroter", "kedge", "chumblade", "oarlock", "deckcleaver", "saltbrand", "oathblade", "powder_horn", "harpoon_reel", "tar_rope", "coral_bite", "barnacle_mace", "foghorn", "salt_scythe", "tide_press", "bilge_hammer", "kraken_bell", "salt_whip", "undertow_pike", "brine_gavel", "broadside", "mooring_pin", "salt_lantern", "rigging_hook", "fog_cutter", "thunderhead", "bilge_wick", "ropes_end", "gafflant", "saltthorn", "grim_reel", "curse_cutter", "belay_hook", "candle_snuff", "lantern_maul", "hull_render", "dirge_edge", "barnacle_edge", "wisp_lure", "anchor_maul", "wraithbell", "gilt_edge", "ledger_edge", "keelscore", "knell_hook", "bilge_maul", "mastfall", "saltverdict", "saltfang", "stay_hook", "wake_bind"]
