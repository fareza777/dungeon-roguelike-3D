...
const DB := {
	...
	"bilge_hook": {"name": "Bilge Hook", "atk": 1.5, "aspd": 0.95, "tier": 2, "mods": {"speed_pct": 0.05}, "desc": "GRIP: every 5th strike hooks deep — the foe drags at half speed for 2s"},
