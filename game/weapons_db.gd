...
"bilge_hammer": {"name": "Bilge Hammer", "tier": 3, "atk": 31, "speed": 0.75, "proc": "SLAM", "proc_desc": "Every 12th strike splashes — 60% ATK to foes nearby", "tint": Color(0.5, 0.45, 0.55), "desc": "a maul that smells of the hold"},
	...
	"keel_lantern": {"name": "Keel Lantern", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.9, 0.75, 0.35), "mods": {"atk": 1.6, "soul_gain_pct": 0.06}, "desc": "+1.6 ATK, +6% souls. LANTERN: every 6th strike dazzles the mark — stuns it briefly and shakes loose a soul."},
	"hull_mender": {"name": "Hull Mender", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.55, 0.8, 0.6), "mods": {"atk": 1.5, "max_hp_pct": 0.05}, "desc": "+1.5 ATK, +5% Max HP. MEND: every 8th strike patches your hull — +1 HP."},
	"keel_judge": {"name": "Keel Judge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.8, 0.6, 0.3), "mods": {"atk": 2.0, "crit": 0.03}, "desc": "+2.0 ATK, +3% Crit. JUDGMENT: every 9th strike passes sentence — fells wounded foes outright (under 15% HP)."},
	"ghost_oar": {"name": "Ghost Oar", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.6, 0.75, 0.8), "mods": {"atk": 1.7, "speed_pct": 0.04}, "desc": "+1.7 ATK, +4% speed. SWEEP: every 6th strike — a spectral stroke shoves the whole pack back."},
	"toll_hook": {"name": "Toll Hook", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.75, 0.65, 0.4), "mods": {"atk": 1.9, "crit": 0.02}, "desc": "+1.9 ATK, +2% Crit. TOLL: every 7th strike rings the ferryman's bell — +1 soul."},
	"deep_lamp": {"name": "Deep Lamp", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.9, 0.75, 0.4), "mods": {"atk": 1.8, "crit": 0.03}, "desc": "+1.8 ATK, +3% Crit. BEACON: every 8th strike lights the foe's position — they burn for 2s."},
	"rip_current": {"name": "Rip Current", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.4, 0.75, 0.85), "mods": {"atk": 1.9, "speed_pct": 0.03}, "desc": "+1.9 ATK, +3% speed. RIP: every 8th strike drags the whole pack into a 2s slog."},
	"mast_stinger": {"name": "Mast Stinger", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.95, 0.6, 0.35), "mods": {"atk": 1.6, "speed_pct": 0.06}, "desc": "+1.6 ATK, +6% speed. STING: every 6th strike lands a second quick jab for 0.5× ATK."},
	"saltwire": {"name": "Saltwire", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.85, 0.8, 0.6), "mods": {"atk": 1.7, "crit": 0.03}, "desc": "+1.7 ATK, +3% Crit. SNARE: every 7th strike tangles the foe in wire — rooted 1.5s."},
	"grim_fathom": {"name": "Grim Fathom", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.4, 0.45, 0.6), "mods": {"atk": 2.0, "speed_pct": -0.06}, "desc": "+2.0 ATK, −6% speed. HOIST: every 8th strike hauls the foe to your feet."},
	"deck_reaver": {"name": "Deck Reaver", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.7, 0.35, 0.3), "mods": {"atk": 1.9, "atk_speed_pct": -0.04}, "desc": "+1.9 ATK, −4% AS. CARVE: every 9th strike lands a boarding cleave for 2.5x ATK."},
	"saltsword": {"name": "Saltsword", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.9, 0.95, 0.95), "mods": {"atk": 2.1, "crit": 0.05}, "desc": "+2.1 ATK, +5% Crit. Sea-steel — brined to a wicked edge, nothing more and nothing less."},
	"keel_hammer": {"name": "Keel Hammer", "gltf": "Skeleton_Axe.gltf", "tint": Color(0.5, 0.45, 0.55), "mods": {"atk": 2.6, "atk_speed_pct": -0.12}, "desc": "+2.6 ATK, −12% AS. SPLINTER: every 8th strike shatters the deck — foes near the mark are hurled back and staggered."},
	"knell_edge": {"name": "Knell Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.75, 0.7, 0.4), "mods": {"atk": 1.8, "atk_speed_pct": 0.04}, "desc": "+1.8 ATK, +4% AS. KNELL: every 9th strike rings the bell — the foe reels back and your purse gains +1 soul."},
	"wake_splitter": {"name": "Wake Splitter", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.45, 0.8, 0.9), "mods": {"atk": 2.0, "speed_pct": 0.05}, "desc": "+2.0 ATK, +5% speed. WAKE: every 10th strike bursts the wake — foes near the mark are thrown back."},
	"pilot_lantern": {"name": "Pilot Lantern", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.8, 0.85, 0.45), "mods": {"atk": 1.7, "soul_gain_pct": 0.06}, "desc": "+1.7 ATK, +6% souls. PILOT: every 8th strike flashes the lamp — the nearest foe staggers blind."},
	"vergers_rod": {"name": "Verger's Rod", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.55, 0.7, 0.6), "mods": {"atk": 1.6, "soul_gain_pct": 0.04}, "desc": "+1.6 ATK, +4% souls. VERGE: every 11th strike rings the rod — nearby foes are shoved and staggered."},
	"brine_jack": {"name": "Brine Jack", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.8, 0.65), "mods": {"atk": 1.5, "speed_pct": 0.03}, "desc": "+1.5 ATK, +3% speed. JACK: every 9th strike wrenches the foe like a lift-cable — hurled far back."},
	"mourning_edge": {"name": "Mourning Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.55, 0.75), "mods": {"atk": 1.7, "crit": 0.02}, "desc": "+1.7 ATK, +2% crit. DIRGE: every 10th strike opens a slow grief — the foe burns for 2s."},
	"grey_oar": {"name": "Grey Oar", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.55, 0.62, 0.5), "mods": {"atk": 1.4, "xp_pct": 0.04}, "desc": "+1.4 ATK, +4% XP. STROKE: every 10th strike rows the nearest foe into reach — dragged to your side."},
	"pale_trident": {"name": "Pale Trident", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.7, 0.85, 0.75), "mods": {"atk": 1.6, "dodge": 0.02}, "desc": "+1.6 ATK, +2% dodge. TRINE: every 3rd strike hobbles the foe — slowed 1.5s."},
	"grey_harpoon": {"name": "Grey Harpoon", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.58, 0.55), "mods": {"atk": 1.8, "dodge": -0.02}, "desc": "+1.8 ATK, −2% dodge. GAFF: every 6th strike hooks the mark and drags it to you."},
	"keelbell": {"name": "Keelbell", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.75, 0.72, 0.55), "mods": {"atk": 1.9}, "desc": "+1.9 ATK. TOLL: every 8th strike rings a 2-tile knell — 0.5x ATK to every foe in reach."},
	"salt_psalter": {"name": "Salt Psalter", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.82, 0.78, 0.6), "mods": {"atk": 2.1, "speed_pct": -0.03}, "desc": "+2.1 ATK, −3% speed. VERSE: every 9th strike is answered — +1 soul."},
	"grey_salter": {"name": "Grey Salter", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.6, 0.66, 0.58), "mods": {"atk": 2.3, "dodge": -0.04}, "desc": "+2.3 ATK, −4% dodge. BRINE: every 7th strike salts the wound — the foe is slowed 2s."},
	"fog_gaff": {"name": "Fog Gaff", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.72, 0.78, 0.82), "mods": {"atk": 1.7, "speed_pct": 0.03}, "desc": "+1.7 ATK, +3% speed. PEAL: every 5th strike rings the foe off its feet — thrown back hard."},
	"wake_anchor": {"name": "Wake Anchor", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.6, 0.68), "mods": {"atk": 2.4, "speed_pct": -0.04}, "desc": "+2.4 ATK, −4% speed. GROUND: every 6th strike drags the foe to a halt — slowed 2s."},
	"toll_blade": {"name": "Toll Blade", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.78, 0.7, 0.5), "mods": {"atk": 2.0}, "desc": "+2.0 ATK. LEVY: every 8th strike collects the sea's share — +1 soul."},
	"crest_blade": {"name": "Crest Blade", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.8, 0.85, 0.9), "mods": {"atk": 1.8, "dodge": 0.04}, "desc": "+1.8 ATK, +4% dodge. BREAKER: every 7th strike crashes like a whitecap — thrown back."},
	"bottom_brand": {"name": "Bottom Brand", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.45, 0.5, 0.62), "mods": {"atk": 2.2, "speed_pct": -0.03}, "desc": "+2.2 ATK, −3% speed. PRESS: every 6th strike lands with trench-weight — stuns 0.7s."},
	"writ_edge": {"name": "Writ Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.7, 0.75, 0.68), "mods": {"atk": 1.9}, "desc": "+1.9 ATK. WRIT: every 9th strike serves the sea's invoice — +1 soul."},
	"pale_gaff": {"name": "Pale Gaff", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.65, 0.68, 0.7), "mods": {"atk": 1.6, "speed_pct": 0.04}, "desc": "+1.6 ATK, +4% speed. HOOK: every 7th strike hauls the foe to you."},
	"audit_edge": {"name": "Audit Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.68, 0.68, 0.62), "mods": {"atk": 2.0}, "desc": "+2.0 ATK. AUDIT: every 8th strike collects the sea's unpaid tax — +1 soul."},
	"bailiff_maul": {"name": "Bailiff's Maul", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.72, 0.7, 0.62), "mods": {"atk": 2.4, "speed_pct": -0.04}, "desc": "+2.4 ATK, −4% speed. SERVE: every 6th strike delivers a writ — stuns the foe 0.8s."},
	"ledger_reaper": {"name": "Ledger Reaper", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.66, 0.68, 0.62), "mods": {"atk": 2.2, "speed_pct": -0.02}, "desc": "the closing book's harvesting blade — POST: every 10th swing posts +2 souls and slows the foe"},
	"folio_edge": {"name": "Folio Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.7, 0.66, 0.6), "mods": {"atk": 2.1, "speed_pct": -0.03}, "desc": "the ledger's page-blade — FOLIO: every 8th swing turns the page: +1 soul and a 0.9s stun"},
	"verdict_edge": {"name": "Verdict Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.6, 0.58, 0.62), "mods": {"atk": 2.3, "speed_pct": -0.04}, "desc": "the pale count's sentencing blade — VERDICT: every 9th swing sentences the foe: +1 soul and a 0.7s stun"},
	"session_edge": {"name": "Session Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.64, 0.62, 0.68), "mods": {"atk": 2.0, "speed_pct": -0.02}, "desc": "the court session's blade — SESSION: every 7th swing hears the case: +1 soul and a 1.5s slow"},
	"scribe_edge": {"name": "Scribe Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.6, 0.55, 0.72), "mods": {"atk": 2.0, "speed_pct": -0.02}, "desc": "the ledger scribe's blade — SCRIBE: every 8th swing enters the foe in the record: +1 soul and a 1.2s slow"},
	"ink_edge": {"name": "Ink Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.32, 0.3, 0.44), "mods": {"atk": 2.1, "speed_pct": -0.02}, "desc": "a blade dipped in the court's own ink — INK: every 9th swing writes the foe still: +1 soul and a 0.8s stun"},
	"verdict_blade": {"name": "Verdict Blade", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.48, 0.4), "mods": {"atk": 2.2, "speed_pct": -0.03}, "desc": "the court's ruling in steel — VERDICT: every 10th swing sentences the foe: +2 souls and a 1.0s stun"},
	"auditor_edge": {"name": "Auditor's Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.8, 0.8, 0.84), "mods": {"atk": 1.8, "speed_pct": 0.05}, "desc": "the field auditor's quill-knife — RECEIPT: every 8th swing files +1 soul and quickens you"},
	"due_edge": {"name": "Due Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.72, 0.74, 0.68), "mods": {"atk": 2.1}, "desc": "the toll-collector's blade — COLLECT: every 9th swing stuns the foe and counts +1 soul"},
	"roll_blade": {"name": "Roll Blade", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.7, 0.73, 0.78), "mods": {"atk": 1.9, "crit_pct": 0.04}, "desc": "the reckoning's measuring edge — TALLY: every 7th swing counts +1 soul"},
	"census_edge": {"name": "Census Edge", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.75, 0.78, 0.85), "mods": {"atk": 2.0, "speed_pct": 0.03}, "desc": "the grey count's measuring blade — ENUMERATE: every 8th swing tallies +1 soul"},
	"docket_blade": {"name": "Docket Blade", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.66, 0.66, 0.64), "mods": {"atk": 1.8, "speed_pct": 0.03}, "desc": "+1.8 ATK, +3% speed. HEARING: every 9th strike convenes — stuns the foe 1s."},
}

const POOL := ["bone_axe", "twin_fang", "hex_staff", "war_blade", "storm_axe", "frost_fang", "ember_mace", "kings_edge", "grave_scythe", "moon_katana", "soul_reaver", "thronebreaker", "hollow_crown", "wisp_lantern", "gravebell", "titan_maul", "sunderfang", "searbrand", "duskblade", "oathbrand", "marsh_claw", "undertow", "keelspike", "pearlrazor", "snapdragon", "conchhorn", "moonshell", "kingfisher", "tidebrand", "harpoon", "driftnet", "guthook", "whelk_maul", "scourge", "chain_anchor", "tide_shear", "whale_saw", "oarblade", "bilge_hook", "brine_cutlass", "silkfang", "saltpeter", "murkmaker", "captains_hook", "riptide_fang", "gaff_hook", "harpooner", "reef_chorus", "quarterstaff", "coral_bludgeon", "salt_pike", "bilge_saw", "storm_petrel", "scurvy_blade", "chimecleaver", "hullbreaker", "king_gavel", "nightfang", "keelhook", "sextant_edge", "mistrune", "oathbreak", "fathom_score", "undertow_blade", "widows_fang", "keelbreak", "galebrand", "brineaxe", "deckhands_edge", "palehook", "sisters_hook", "saltcaller", "belaying_pin", "grog_blade", "rustwake", "oarsplitter", "saltline", "bilge_lantern", "mirenet", "stanchion", "thresh_hook", "wakefang", "garroter", "kedge", "chumblade", "oarlock", "deckcleaver", "saltbrand", "oathblade", "powder_horn", "harpoon_reel", "tar_rope", "coral_bite", "barnacle_mace", "foghorn", "salt_scythe", "tide_press", "bilge_hammer", "kraken_bell", "salt_whip", "undertow_pike", "brine_gavel", "broadside", "mooring_pin", "salt_lantern", "rigging_hook", "fog_cutter", "thunderhead", "bilge_wick", "ropes_end", "gafflant", "saltthorn", "grim_reel", "curse_cutter", "belay_hook", "candle_snuff", "lantern_maul", "hull_render", "dirge_edge", "barnacle_edge", "wisp_lure", "anchor_maul", "wraithbell", "gilt_edge", "ledger_edge", "keelscore", "knell_hook", "bilge_maul", "mastfall", "saltverdict", "saltfang", "stay_hook", "wake_bind", "keel_lantern", "hull_mender", "keel_judge", "ghost_oar", "toll_hook", "deep_lamp", "rip_current", "mast_stinger", "saltwire", "grim_fathom", "deck_reaver", "saltsword", "keel_hammer", "knell_edge", "wake_splitter", "pilot_lantern", "vergers_rod", "brine_jack", "mourning_edge", "grey_oar", "pale_trident", "grey_harpoon", "keelbell", "salt_psalter", "grey_salter", "fog_gaff", "wake_anchor", "toll_blade", "crest_blade", "bottom_brand", "writ_edge", "pale_gaff", "audit_edge", "bailiff_maul", "docket_blade", "census_edge", "roll_blade", "due_edge", "auditor_edge", "ledger_reaper", "folio_edge", "verdict_edge", "session_edge", "scribe_edge", "ink_edge", "verdict_blade"]
