...
const DB := {
	...
	"galebrand": {"name": "Galebrand", "gltf": "Skeleton_Blade.gltf", "tint": Color(0.5, 0.85, 0.75), "mods": {"atk": 1.15, "aspd": 1.1}, "desc": "+1.15 ATK, +10% speed. GUST: every 3rd strike throws the whole knot of them back."},
